<template>
  <v-content>
    ...
    <div class="block">
      <v-container>
        <p>We are From President University. We creating web for our final Server Side Programming.</p>
      </v-container>
    </div>
    <div class="block">
      <v-container>
  ...
  data() {
    return {
      items: [
        ...
        {
          id: 3,
          src: require("../assets/images/team1.jpeg"),
          name: 'Muhammad Ari Sasmoko',
          title: 'Front End'
        }
      ]
    };
